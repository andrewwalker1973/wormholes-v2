...
namespace CrossPlatformSaveSystem
{
	public class ExampleCustomFile : MonoBehaviour
	{
		...
		public void ButtonOption (int index)
		{
			...
			SampleCustomFile customFile = (SampleCustomFile)SaveSystem.Load (fileName, Application.streamingAssetsPath);
		...
		private void CreateOption (int index, string plot, bool trigger1, bool trigger2)
		{
			...
			SaveSystem.Save (customFile, fileName, Application.streamingAssetsPath);
		}
